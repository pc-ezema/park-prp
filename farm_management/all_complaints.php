                    ...
                    <div class="card">
                        <div class = "panel panel-success">
                            <div class = "panel-heading">
                                ...
                                <a href="print_all_complaints.php">
                        ...
                        <div id="print">
                            ...
                            <div class="body">
                                ...
                                <thead>
                                    <tr>
                                        <td>Units</td>
                                        <td>Complaints Names</td>
                                        <td>Basis of Complaints</td>
										<td>Date of Complaints</td>
										<td>Complaints Received By</td>
                                        <td>Action Plan for Complaints</td>
                                ...
                                <tbody class="alert-success">
								  ...
								  <td>     
                                    <a class="btn btn-success btn-sm" href="edit_complaints.php?id=<?php echo $row['id']?>">
                                      <span class = "glyphicon glyphicon-pencil" aria-hidden = "true">Edit</span>
                                    </a> 
									<a class="btn btn-success btn-sm" href="query/delete_complaints_query.php?id=<?php echo $row['id']?>">
