...
$result=$con->prepare("SELECT * FROM repairslog WHERE id='{$_GET['id']}'");
$result->execute();
...
?>		
    ...
    <section class="content">
        <div class="container-fluid">
               <!-- Input Group -->
        <form action="query/edit_repairs_query.php" method="POST" enctype="multipart/form-data" name="form1" id="form1">
                                ...
                                <div class="row clearfix">
									...
									<div class="col-sm-6">
                                        <div>
                                            ...
                                            <div class="form-line">
                                                <textarea type="text" class="form-control" rows="1" name="equip_desc" style="resize:none;" required><?php echo $row['EquipmentDescription']; ?></textarea>
                                            </div>
                                        </div>
                                    </div>	
									...
									<div class="col-sm-6">
                                        <div>
                                            ...
                                            <div class="form-line">
                                                <textarea type="text" class="form-control" rows="8" name="desc_defect" style="resize:none;" required><?php echo $row['DescriptionofDefect']; ?></textarea>
                                            </div>
                                        </div>
                                    </div>	
									...
									<div class="col-sm-6">
                                        <div>
                                            ...
                                            <div class="form-line">
												<input type="date" class="form-control" name="date_time" value="<?php echo $row['DateTimeRepair']; ?>" required>
                                            </div>
                                        </div>
                                    </div>	
									...
									<div class="col-sm-6">
                                        <div>
                                            ...
                                            <div class="form-line">
												<input type="text" class="form-control" name="repair_performed" value="<?php echo $row['RepairPerformedBy']; ?>" required>
                                            </div>
                                        </div>
                                    </div>	
									...
									<div class="col-sm-6">
                                        <div>
                                            ...
                                            <div class="form-line">
												<input type="number" class="form-control" name="cost_repair" value="<?php echo $row['CostofRepair']; ?>" required>
                                            </div>
                                        </div>
                                    </div>
									...
									<div class="col-sm-12">
                                        <div>
                                            ...
                                            <div class="form-line">
												<textarea type="text" class="form-control" rows="5" name="desc_repair" style="resize:none;" required><?php echo $row['DescriptionofRepair']; ?></textarea>
                                            </div>
                                        </div>
                                    </div>	
									...
									<div class="col-sm-12">
                                        <div>
                                            ...
                                            <div class="form-line">
												<textarea type="text" class="form-control" rows="2" name="remarks" style="resize:none;" required><?php echo $row['Remarks']; ?></textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div> 
