...
<script src="js/bootstrap.js"></script>
	...
	<ul class="cb-slideshow">
		...
		<tr>
			...
			<p style="background-color:green; margin-left:40px; padding: 10px; float:left"><img src="images/user.png" height="50px" /></p></br> <p style="font-size: 16px; color: white">Facility </br>Manager</p></div>
			...
			<input type="text" class="hidden" value="Facility Manager" name="name" id="name"></input>
