                    ...
                    <div class="card">
                        <div class = "panel panel-success">
                            <div class = "panel-heading">
								...
								<a href="add_recommendations.php">
                        ...
                        <div id="print">
                            ...
                            <div class="body">
                                ...
                                <tbody class="alert-success">
								  ...
								  <td>     
                                     <a href="edit_recommendations.php?id=<?php echo $row['id']?>" class="btn btn-primary">
                                      <span class = "glyphicon glyphicon-pencil" aria-hidden = "true">Edit</span>
                                    </a>
									<a class="btn btn-success btn-sm" href="query/delete_recommendations_query.php?id=<?php echo $row['id']?>">
