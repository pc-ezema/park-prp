    ...
    <nav class="navbar">
        <div class="container-fluid" style="background-color:green;">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="home.php" style="color: #fff;">Facility Manager</a>
                ...
                <ul class="list">
                    ...
                    <li>
                        ...
                        <ul class="ml-menu">
							...
							<li>
                                <a href="building_maintenance.php">Building Maintenance</a>
                            </li>
                            <li>
							...
							<li>
                                <a href="all_complaints.php">Complaints</a>
                            </li>
                            <li>
					...
					<li>
                        <a href="javascript:void(0);" class="menu-toggle">
                            ...
                            <i class="glyphicon glyphicon-tasks"></i>&nbsp;&nbsp;Inventory
                        </a>
                        <ul class="ml-menu">
                        
                            <li>
                                <a href="all_farm_units.php">All Units</a>
                            </li>
                        </ul>
                    </li>
					<li>
