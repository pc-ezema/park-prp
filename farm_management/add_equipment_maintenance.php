<?php include("header.php") ?>
    ...
    <section class="content">
        <div class="container-fluid">
               <!-- Input Group -->
        <form action="query/add_equipmentmaintenance_query.php" method="POST" enctype="multipart/form-data" name="form1" id="form1">
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class = "panel panel-success">
                            <div class = "panel-heading">
                                <h4>Add Equipment Maintenance</h4>
                            </div>
                        </div>
                        <div class="body">
                                ...
                                <div class="row clearfix">
									...
									<div class="col-sm-5">
                                        <div>
                                            ...
                                            <div class="form-line">
                                                <textarea type="text" class="form-control" rows="8" name="equip_desc" style="resize:none;" required></textarea>
                                            </div>
                                        </div>
                                    </div>	
									...
									<div class="col-sm-5">
                                        <div>
                                            ...
                                            <div class="form-line">
												<textarea type="text" class="form-control" rows="8" name="main_desc" style="resize:none;" required></textarea>
                                            </div>
                                        </div>
                                    </div>	
									...
									<div class="col-sm-7">
                                        <div>
                                            ...
                                            <div class="form-line">
												<input type="date" class="form-control" name="main_date" required>
                                            </div>
                                        </div>
                                    </div>	
									...
									<div class="col-sm-7">
                                        <div>
                                            ...
                                            <div class="form-line">
												<input type="text" class="form-control" name="main_performed" required>
                                            </div>
                                        </div>
                                    </div>
									...
									<div class="col-sm-7">
                                        <div>
                                            ...
                                            <div class="form-line">
												<input type="number" class="form-control" name="cost_maintenance" required>
                                            </div>
                                        </div>
                                    </div>	
									...
									<div class="col-sm-5">
                                        <div>
                                            ...
                                            <div class="form-line">
											<textarea type="text" class="form-control" rows="4" name="nmain_plan" style="resize:none;" required></textarea>
                                            </div>
                                        </div>
                                    </div>
