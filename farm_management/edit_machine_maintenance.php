...
$result=$con->prepare("SELECT * FROM machinelog WHERE id='{$_GET['id']}'");
$result->execute();
...
?>		
    ...
    <section class="content">
        <div class="container-fluid">
               <!-- Input Group -->
        <form action="query/edit_machinemaintenance_query.php" method="POST" enctype="multipart/form-data" name="form1" id="form1">
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class = "panel panel-success">
                            <div class = "panel-heading">
                                <h4>Edit Machine Maintenance</h4>
                            </div>
                        </div>
                        <div class="body">
                                ...
                                <div class="row clearfix">
									...
									<div class="col-sm-5">
                                        <div>
                                            ...
                                            <div class="form-line">
                                                <textarea type="text" class="form-control" rows="8" name="machine_desc" style="resize:none;" required><?php echo $row['MachineDescription']; ?></textarea>
                                            </div>
                                        </div>
                                    </div>	
