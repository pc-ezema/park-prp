...
$result=$con->prepare("SELECT * FROM postharvestitems WHERE i_id='{$_GET['id']}'");
$result->execute();
...
foreach ($fetch as $key => $row) {
    ...
    $i_items = $row['i_items'];
    $i_qty = $row['i_qty'];
    $i_dpurchase = $row['i_dpurchase'];
	$i_amount = $row['i_amount'];
    $i_purchaseby = $row['i_purchaseby'];
    $i_receiveby = $row['i_receiveby'];
                        ...
                        <div  class="container-fluid" style="background-color: #ddd;">
                            <div class="demo-masked-input">
                                <div class="row clearfix">
                                    ...
                                    <input type="submit" name="postharvestupdate" value="Update" class="btn btn-success" style ="float:right; margin-top: -30px;">                   
                                </div>
                            </div>
                        </div>
                    </div>
