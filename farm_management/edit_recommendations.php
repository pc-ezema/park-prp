...
$result=$con->prepare("SELECT * FROM recommendationlog WHERE id='{$_GET['id']}'");
$result->execute();
...
?>		
    ...
    <section class="content">
        <div class="container-fluid">
               <!-- Input Group -->
        <form action="query/edit_recommendations_query.php" method="POST" enctype="multipart/form-data" name="form1" id="form1">
                                ...
                                <div class="row clearfix">
									...
									<div class="col-sm-6">
                                        <div>
                                            ...
                                            <div class="form-line">
                                                <textarea type="text" class="form-control" rows="4" name="recommendation" style="resize:none;" required><?php echo $row['Recommendation']; ?></textarea>
                                            </div>
                                        </div>
                                    </div>	
									...
									<div class="col-sm-6">
                                        <div>
                                            ...
                                            <div class="form-line">
												<input type="date" class="form-control" name="date_recommendation" value="<?php echo $row['DateofRecommendation']; ?>" required>
                                            </div>
                                        </div>
                                    </div>	
									...
									<div class="col-sm-6">
                                        <div>
                                            ...
                                            <div class="form-line">
												<textarea type="text" class="form-control" rows="4" name="reasons_recommendation" style="resize:none;" required><?php echo $row['ReasonsforRecommendation']; ?></textarea>
                                            </div>
                                        </div>
                                    </div>	
									...
									<div class="col-sm-6">
                                        <div>
                                            ...
                                            <div class="form-line">
												<textarea type="text" class="form-control" rows="4" name="expected_change" style="resize:none;" required><?php echo $row['ExpectedChange']; ?></textarea>
                                            </div>
                                        </div>
                                    </div>	
