                                ...
                                <div class="row clearfix">
									...
									<div class="col-sm-3">
                                        <div>
                                            ...
                                            <div class="form-line">
                                                <textarea type="text" class="form-control" rows="16" name="items" style="resize:none;" required></textarea>
                                            </div>
                                        </div>
                                    </div>	
									...
									<div class="col-sm-9">
                                        <div>
                                            ...
                                            <div class="form-line">
												<input type="text" class="form-control" name="purchasedby" required>
                                            </div>
                                        </div>
                                    </div>	
                                    ...
                                    <input type="submit" name="postharvest" value="SAVE" class="btn btn-success" style ="float:right; margin-top: -30px;"></br>                   
                                </div>
                            </div>
                        </div>
                    </div>
