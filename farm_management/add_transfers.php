<?php include("header.php") ?>
    ...
    <section class="content">
        <div class="container-fluid">
               <!-- Input Group -->
        <form action="query/add_transfers_query.php" method="POST" enctype="multipart/form-data" name="form1" id="form1">
                                ...
                                <div class="row clearfix">
									...
									<div class="col-sm-6">
                                        <div>
                                            ...
                                            <div class="form-line">
                                                <textarea type="text" class="form-control" rows="4" name="equip_desc" style="resize:none;" required></textarea>
                                            </div>
                                        </div>
                                    </div>	
									...
									<div class="col-sm-6">
                                        <div>
                                            ...
                                            <div class="form-line">
												<input type="text" class="form-control" name="unit_trans_from" required>
                                            </div>
                                        </div>
                                    </div>
									...
									<div class="col-sm-6">
                                        <div>
                                            ...
                                            <div class="form-line">
												<input type="text" class="form-control" name="unit_trans_to" required>
                                            </div>
                                        </div>
                                    </div>
									...
									<div class="col-sm-6">
                                        <div>
                                            ...
                                            <div class="form-line">
												<input type="text" class="form-control" name="transferred_by" required>
                                            </div>
                                        </div>
                                    </div>	
									...
									<div class="col-sm-6">
                                        <div>
                                            ...
                                            <div class="form-line">
												<input type="date" class="form-control" name="date_transferred" required>
                                            </div>
                                        </div>
                                    </div>
									...
									<div class="col-sm-6">
                                        <div>
                                            ...
                                            <div class="form-line">
												<input type="text" class="form-control" name="transfer_received" required>
                                            </div>
                                        </div>
                                    </div>
									...
									<div class="col-sm-6">
                                        <div>
                                            ...
                                            <div class="form-line">
												<textarea type="text" class="form-control" rows="4" name="reasons_transfer" style="resize:none;" required></textarea>
                                            </div>
                                        </div>
                                    </div>	
									...
									<div class="col-sm-6">
                                        <div>
                                            ...
                                            <div class="form-line">
												<textarea type="text" class="form-control" rows="4" name="remarks" style="resize:none;" required></textarea>
                                            </div>
                                        </div>
                                    </div>
