                        ...
                        <div id="print">
                            ...
                            <div class="body">
                             ...
                             <table id = "example" class = "stripe" cellspacing = "0" >
								...
								<?php
                                    include('connect.php');
                                    $display = $con->prepare("SELECT * FROM apicitems ORDER BY i_id DESC");
                                    $display->execute();
								  ...
								  <td>     
                                     <a href="edit_apic.php?id=<?php echo $row['i_id']?>" class="btn btn-primary">
                                      <span class = "glyphicon glyphicon-pencil" aria-hidden = "true">Edit</span>
                                    </a>
									<a class="btn btn-success btn-sm" href="query/delete_inventory_query.php?apicid=<?php echo $row['i_id']?>">
