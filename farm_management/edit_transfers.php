...
$result=$con->prepare("SELECT * FROM transferlog WHERE id='{$_GET['id']}'");
$result->execute();
...
?>		
    ...
    <section class="content">
        <div class="container-fluid">
               <!-- Input Group -->
        <form action="query/edit_transfers_query.php" method="POST" enctype="multipart/form-data" name="form1" id="form1">
                                ...
                                <div class="row clearfix">
									...
									<div class="col-sm-6">
                                        <div>
                                            ...
                                            <div class="form-line">
                                                ...
                                                <textarea type="text" class="form-control" rows="4" name="equip_desc" style="resize:none;" required><?php echo $row['EquipmentDescription']; ?></textarea>
                                            </div>
                                        </div>
                                    </div>	
									...
									<div class="col-sm-6">
                                        <div>
                                            ...
                                            <div class="form-line">
												<input type="text" class="form-control" name="unit_trans_from" value="<?php echo $row['UnitTransferredFrom']; ?>" required>
                                            </div>
                                        </div>
                                    </div>
									...
									<div class="col-sm-6">
                                        <div>
                                            ...
                                            <div class="form-line">
												<input type="text" class="form-control" name="unit_trans_to" value="<?php echo $row['UnitTransferredTo']; ?>" required>
                                            </div>
                                        </div>
                                    </div>
									...
									<div class="col-sm-6">
                                        <div>
                                            ...
                                            <div class="form-line">
												<input type="text" class="form-control" name="transferred_by" value="<?php echo $row['TransferredBy']; ?>" required>
                                            </div>
                                        </div>
                                    </div>	
									...
									<div class="col-sm-6">
                                        <div>
                                            ...
                                            <div class="form-line">
												<input type="date" class="form-control" name="date_transferred" value="<?php echo $row['DateTransferred']; ?>" required>
                                            </div>
                                        </div>
                                    </div>
									...
									<div class="col-sm-6">
                                        <div>
                                            ...
                                            <div class="form-line">
												<input type="text" class="form-control" name="transfer_received" value="<?php echo $row['TransferReceivedBy']; ?>" required>
                                            </div>
                                        </div>
                                    </div>
									...
									<div class="col-sm-6">
                                        <div>
                                            ...
                                            <div class="form-line">
												<textarea type="text" class="form-control" rows="4" name="reasons_transfer" style="resize:none;" required><?php echo $row['ReasonsforTransfer']; ?></textarea>
                                            </div>
                                        </div>
                                    </div>	
