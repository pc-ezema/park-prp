                    ...
                    <div class="card">
                        <div class = "panel panel-success">
                            <div class = "panel-heading">
                                <h4>Machine Maintenance</h4>
								<a href="add_machine_maintenance.php">
                        ...
                        <div id="print">
                            ...
                            <div class="body">
                                ...
                                <tbody class="alert-success">
								  ...
								  <td>     
                                     <a href="edit_machine_maintenance.php?id=<?php echo $row['id']?>" class="btn btn-primary">
                                      <span class = "glyphicon glyphicon-pencil" aria-hidden = "true">Edit</span>
                                    </a>
									<a class="btn btn-success btn-sm" href="query/delete_machinemaintenance_query.php?id=<?php echo $row['id']?>">
