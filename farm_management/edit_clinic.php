...
$result=$con->prepare("SELECT * FROM clinicitems WHERE i_id='{$_GET['id']}'");
$result->execute();
                        ...
                        <div  class="container-fluid" style="background-color: #ddd;">
                            <div class="demo-masked-input">
                                <div class="row clearfix">
                                    ...
                                    <input type="submit" name="clinicupdate" value="Update" class="btn btn-success" style ="float:right; margin-top: -30px;">                   
                                </div>
                            </div>
                        </div>
                    </div>
