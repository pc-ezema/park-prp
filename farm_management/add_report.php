<?php include("header.php") ?>
    ...
    <section class="content">
        <div class="container-fluid">
               <!-- Input Group -->
        <form action="query/upload_query.php" method="POST" enctype="multipart/form-data" name="form1" id="form1">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div>
                                            ...
                                            <div class="form-line">
                                                ...
                                                <input type="hidden" class="form-control" name="department" value="Facility Manager" required>
                                            </div>
                                        </div>
									</div>	
									<div class="col-sm-4">
