    <div id="validate_leaveCredits"></div>
     <form class="form-horizontal span6 " action="controller.php?action=addIOC" method="POST"> 
...
" type="text" value="" required  onkeyup="javascript:capitalize(this.id, this.value);"
    ...
    <div class="form-group">
      ...
      <div class="col-md-12">
        <label class="col-md-4 control-label" for=
        "IOC_POSITION">Position</label>

        <div class="col-md-8">
           <input type="text" class="form-control input-sm IOC_POSITION" id="IOC_POSITION" name="IOC_POSITION" placeholder=
