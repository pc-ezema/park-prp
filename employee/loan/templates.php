        ...
        <nav class="navbar navbar-mod navbar-fixed-top" role="banner" style="background-color:green;">
            <div class="container">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="<?php echo web_root; ?>employee/index.php"><img style="width:70px" height="60px" src="<?php echo web_root; ?>admin/img/bg/agrologo.jpg" alt="logo"></a> 
                </div>
                
                <div class="collapse navbar-collapse navbar-right">
                    <ul class="nav navbar-nav mod-menu" style="font-size:13px;"  >
                        <li hover="ff9933" class="<?php echo ($_GET['page'] == 1) ? "active" : false;?>">  <a href="<?php echo web_root; ?>employee/loan/viewemployeeloan.php">View Loan</a></li>
