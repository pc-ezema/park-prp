...
$employee = New Employee();
    $emp = $employee->single_employee($_GET['employeeid']);

    $leavescredit = New LeavesCredit();
    $lcredits = $leavescredit->single_leavescredit($emp->EMPLOYEEID);
            ...
            <div class="features"> 
                <div class="row">
                  <div class="col-xs-12" style="padding:0px;" align="center">
                    <label>PARK ADMINISTRATIVE SERVICE</label> 
                ...
                <div class="row">
                  ...
                  <table class="tbl">
                    ...
                    <tr>
                      ...
                      <td colspan="5" class="underline"  style="font-size:12px">PARK ADMINISTRATIVE SERVICES</td> 
                    </tr>
                     <tr>
                      <td colspan="3" align="center">Employee</td> 
                      <td colspan="3" align="center">Department Head</td> 
