	...
	if(ISSET($_POST['save'])){
		...
		if(in_array($end, $allowed_ext)){
			if(move_uploaded_file($image_temp, $path)){
				mysqli_query($conn, "INSERT INTO `tblpss` VALUES('', '$CODE','$SNAME','$ONAME','$HADDRESS','$Sex',
							'$DateofBirth', '$Religion', '$StateofOrigin', '$LGA', '$TELNO', '$MaritalStatus', '$ArrivalDate', '$FarmExperience', '$Skills', '$Trainings',
							'$AccountName', '$BankName', '$AccountNumber', '$KinName', '$KinRelationship', '$KinOccupation', '$KinAddress', '$KinPhoneNumber', 
							'$DateResumption', '$Department', '$ParkHumanResource', '$path')") or die(mysqli_error());
