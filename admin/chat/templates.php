...
<head>
    ...
    <title>SUGGESTION | PARK ADMINISTRATIVE SERVICES</title>
        ...
        <nav class="navbar navbar-mod navbar-fixed-top" role="banner" style="background-color:green;">
            <div class="container">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="<?php echo web_root; ?>admin/index.php"><img style="width:70px" height="50px" src="<?php echo web_root; ?>admin/img/bg/agrologo.jpg" alt="logo"></a> 
                </div>
