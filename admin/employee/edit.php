...
// $res = $autonum->single_autonumber(2);
 @$empid = $_GET['id'];
  ...
  $credits = $lcredits->single_leavescredit($empid);
                                ...
                                <div class="col-md-8">
                                 ...
                                 <option value="none" >Select</option>
                                    <?php  
                                       ...
                                       $mydb->setQuery("SELECT * FROM `tbldepartment` WHERE DEPARTMENTID=".$emp->DEPARTMENTID);
                                       $cur = $mydb->loadResultList();

                                        foreach ($cur as $result) {
                                          echo '<option SELECTED value='.$result->DEPARTMENTID.' >'.$result->DEPARTMENT.' </option>';
                                ...
                                <div class="col-md-8">
                                 ...
                                 <option value="none" >Select</option>
                                    <?php  
                                       ...
                                       $mydb->setQuery("SELECT * FROM `tbldivision` WHERE DIVISIONID=".$emp->DIVISIONID);
                                       $cur = $mydb->loadResultList();

                                        foreach ($cur as $result) {
                                          echo '<option SELECTED value='.$result->DIVISIONID.' >'.$result->DIVISION.' </option>';
