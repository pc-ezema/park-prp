...
require_once("../../include/initialize.php");
  ...
  redirect(web_root."index.php");
    ...
    $fambackground = New FamilyBackground();
  	$fam = $fambackground->single_familybackground($_GET['id']);
?>
<!DOCTYPE html>
<html>
<head>
...
<div class="wrapper">
  ...
  <table class="table table-bordered" padding="0" style="font-size:12px">
    ...
    <?php    
		@$mydb->setQuery("SELECT * 
		        FROM   `tblchildren` WHERE EMPLOYEEID='".$_GET['id']."'");
 ...
 <table class="table table-striped  table-hover table-bordered" style="font-size:12px" cellspacing="0">
  ...
  <?php    
      ...
      @$educ     = $education->single_edubackground($_GET['id']); 
    ?>
    <tr>
      <td>Elementary</td>
...
<table class="table   table-bordered" style="font-size:12px" cellspacing="0">
 ...
 <table class="table   table-bordered" style="font-size:12px;text-align: center;" cellspacing="0">
   <tr>
     <td colspan="2">
      I, hereby affirm that, to the best of m y knowledge, all information provided in this form is true and correct.<br/>
      Not: - The company reserves the right to terminate your appointment if any of the information provided in this form is eventually found to be untrue.
     </td>
     <td>
