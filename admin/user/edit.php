                                  ...
                                  <div class="col-md-8">
                                    <input name="deptid" type="hidden" value="">
                                     <input class="form-control input-sm" id="U_NAME" name="U_NAME" placeholder=
                                        "Account Name" type="text" value="<?php echo $singleuser->FULLNAME; ?>" autocomplete="off">
                                  ...
                                  <div class="col-md-8">
                                    <input name="deptid" type="hidden" value="">
                                     <input class="form-control input-sm" id="U_USERNAME" name="U_USERNAME" placeholder=
                                        "Username" type="text" value="<?php echo $singleuser->USERNAME; ?>" autocomplete="off">
                                  ...
                                  <div class="col-md-8">
                                    ...
                                    <div class="col-md-8">
                                     <select class="form-control input-sm" name="U_ROLE" id="U_ROLE">
                                        <option value="Administrator"  <?php echo ($singleuser->UROLE=='Administrator') ? 'selected="true"': '' ; ?>>Administrator</option>
                                        <!-- <option value="Staff" <?php echo ($singleuser->UROLE=='Staff') ? 'selected="true"': '' ; ?>>Staff</option>  -->
                                        <!-- <option value="Customer">Customer</option> -->
                                            <option value="HR" <?php echo ($singleuser->UROLE=='HR') ? 'selected="true"': '' ; ?>>HR</option>
                                   <!-- <option value="Encoder" <?php echo ($singleuser->UROLE=='Encoder') ? 'selected="true"': '' ; ?>>Encoder</option> -->
                                      </select> 
                                    </div>
                                  </div>
                                </div>
                          ...
                          <?php } ?>
                           <div class="form-group">
                                  <div class="col-md-8">
                                    ...
                                    <div class="col-md-8">
                                       <button class="btn btn-mod save " name="save" type="submit" ><span class="fa fa-save fw-fa"></span> Save</button>
