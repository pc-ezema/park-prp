      <form class="form-horizontal span6 " action="controller.php?action=addchild" method="POST"> 
      ...
      <div class="col-md-12">
        ...
        <div class="col-md-8">
           ...
           <textarea class="form-control input-sm" id="NAMEOFCHILD" name="NAMEOFCHILD" placeholder=
              "Name of Child" type="text" value="" required  onkeyup="javascript:capitalize(this.id, this.value);"
        ...
        <div class="col-md-8">
           <div class="input-group" id=""> 
                <div class="input-group-addon"> 
                 ...
                 <input Required  autocomplete="off" id="DATEOFBIRTH" name="DATEOFBIRTH"  
                 type="text" class="form-control" data-inputmask="'alias': 'mm/dd/yyyy'" data-mask>
