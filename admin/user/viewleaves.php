          ...
          <div class="tab-pane fade active in" id="one">
                 <table class="table table-striped  table-responsive"> 
                    ...
                    <tr>
                      ...
                      <td colspan="2">
                        <label><?php echo $credits->VACATION; ?></label>
                      </td> 
                      <td ><label>Sick :</label></td>
                      <td colspan="2"> 
                      <div class="input-group " > 
                          <label><?php echo  $credits->SICK; ?> </label>   
                       </div>             
                      </td> 
                    </tr> 
                    <tr>
<?php if($emp->SEX=='Female' && $emp->CIVILSTATUS != 'Single'){ ?>
                    <td ><label>Maternity :</label></td>
                      <td colspan="2"> 
                      <div class="input-group " > 
                          <label><?php echo  $credits->MATERNITY; ?> </label>   
                       </div>             
                      </td> 
...
<?php } ?>
                  <!--   <td><label>SSS :</label></td>
                      <td colspan="2" >
                        <label><?php echo $credits->SSS; ?></label> 
                            </td> -->
                <!--     <td  ><label>Emergency</label></td>
                      <td colspan="2">
                        <label><?php echo $credits->EMERGENCY; ?></label> 
                            </td>
                    </tr>  
                    <tr> -->
                    ...
                    <td><label>Service Credits :</label></td>
                      <td colspan="4" >
                        <label><?php echo $credits->OTHERS; ?></label> 
                            </td>
            ...
            <table id="dash-table" class="table table-striped table-bordered table-hover table-responsive" style="font-size:11px" cellspacing="0">
                ...
                <tbody>
                  <?php  
                    ...
                    $mydb->setQuery("SELECT * FROM `tblleaves`  WHERE EMPLOYEEID='".$_SESSION['USERID']."' ORDER BY LEAVESTATUS='Pending' AND LEAVEID DESC");
