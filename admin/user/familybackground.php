...
<?php
 ...
 $fambackground = New FamilyBackground();
  $fam = $fambackground->single_familybackground($_SESSION['USERID']);
...
<div class=" col-lg-12" style="background-color:#000; color:#fff;font-size:15px;padding:2px">Family Background</div>
  ...
  <div class=" col-lg-12" style=" font-size:12px;padding:2px"><label>Spouse</label></div>
    <div class="row">
      ...
      <div class="col-lg-6"><input type="input" class="form-control input-xs" name="SPOUSE_LNAME" value="<?php echo $fam->SPOUSE_LNAME; ?>"></div> 
    </div> 
    <div class="row">
       <label class="col-lg-4">First Name</label>
      <div class="col-lg-6"><input type="input" class="form-control input-xs" name="SPOUSE_FNAME" value="<?php echo $fam->SPOUSE_FNAME; ?>"></div>
    </div>
    <div class="row">
       <label class="col-lg-4">Middle Name</label>
      <div class="col-lg-6"><input type="input" class="form-control input-xs" name="SPOUSE_MNAME" value="<?php echo $fam->SPOUSE_MNAME; ?>"></div>
    </div>
    <div class="row">
       <label class="col-lg-4">Occupation</label>
      <div class="col-lg-6"><input type="input" class="form-control input-xs" name="OCCUPATION" value="<?php echo $fam->OCCUPATION; ?>"></div>
    </div>
    <div class="row">
       <label class="col-lg-4">Employer/BusinessName</label>
      <div class="col-lg-6"><input type="input" class="form-control input-xs" name="EMPLOYER_BUSNAME" value="<?php echo $fam->EMPLOYER_BUSNAME; ?>"></div>
    </div>
    <div class="row">
       <label class="col-lg-4">Business Address</label>
      <div class="col-lg-6"><input type="input" class="form-control input-xs" name="BUSADDRESS" value="<?php echo $fam->BUSADDRESS; ?>"></div>
    </div>
    <div class="row">
       <label class="col-lg-4">Employer/Bus. Tel. No.</label>
      <div class="col-lg-6"><input type="input" class="form-control input-xs" name="EMPLOYER_BUSTELNO" value="<?php echo $fam->EMPLOYER_BUSTELNO; ?>"></div>
    </div>
    <div class="row">
       <label class="col-lg-4">Contact No. of Spouse</label>
      <div class="col-lg-6"><input type="input" class="form-control input-xs" name="SPOUSE_CONTACTNO" value="<?php echo $fam->SPOUSE_CONTACTNO; ?>"></div>
    </div>
    <div class=" col-lg-12" style="background-color:#000; color:#fff">Father</div>
    <div class="row">
       <label class="col-lg-4">Surname</label>
      <div class="col-lg-6"><input type="input" class="form-control input-xs" name="FATHER_LNAME" value="<?php echo $fam->FATHER_LNAME; ?>"></div>
    </div>
    <div class="row">
       <label class="col-lg-4">First Name</label>
      <div class="col-lg-6"><input type="input" class="form-control input-xs" name="FATHER_FNAME" value="<?php echo $fam->FATHER_FNAME; ?>"></div>
    </div>
    <div class="row">
       <label class="col-lg-4">Middle Name</label>
      <div class="col-lg-6"><input type="input" class="form-control input-xs" name="FATHER_MNAME" value="<?php echo $fam->FATHER_MNAME; ?>"></div>
    </div>
    <div class=" col-lg-12" style="background-color:#000; color:#fff">Mother Maiden Name</div>
    <div class="row">
       <label class="col-lg-4">Surname</label>
      <div class="col-lg-6"><input type="input" class="form-control input-xs" name="MOTHER_LNAME" value="<?php echo $fam->MOTHER_LNAME; ?>"></div>
    </div>
    <div class="row">
       <label class="col-lg-4">First Name</label>
      <div class="col-lg-6"><input type="input" class="form-control input-xs" name="MOTHER_FNAME" value="<?php echo $fam->MOTHER_FNAME; ?>"></div>
    </div>
    <div class="row">
       <label class="col-lg-4">Middle Name</label>
      <div class="col-lg-6"><input type="input" class="form-control input-xs" name="MOTHER_MNAME" value="<?php echo $fam->MOTHER_MNAME; ?>"></div>
    </div>
  </div>

  <div class="col-lg-2" >
  <div class="col-lg-12" style="padding:3px">
    <a  data-toggle="lightbox" href="addchild.php" class="btn btn-sm btn-info fa fa-plus-circle fw-fa">Add Child</a>
  </div>
  <table class="table table-bordered" padding="0">
    ...
    <?php   
                    ...
                    $mydb->setQuery("SELECT * 
                            FROM   `tblchildren` WHERE EMPLOYEEID='".$_SESSION['USERID']."'");
                  ...
                  foreach ($cur as $result) { 
                    ...
                    echo '<td align="center" >   
                             <a data-toggle="lightbox" title="Edit" href="editchild.php?id='.$result->CHILDID.'"  class="btn btn-info btn-xs  ">
                             <span class="fa fa-edit fw-fa"></span></a> 
                       <a title="Delete" href="controller.php?action=deletechild&id='.$result->CHILDID.'" class="btn btn-danger btn-xs" 
