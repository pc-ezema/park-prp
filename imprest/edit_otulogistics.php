...
$result=$con->prepare("SELECT * FROM otulogisticsimprest WHERE id='{$_GET['id']}'");
$result->execute();
                    ...
                    <div class="card">
                        <div class = "panel panel-success">
                            <div class = "panel-heading">
                                <h4>Edit Otulogistics Imprest</h4>
                            </div>
                        </div>
                        <div class="body">
                        <div  class="container-fluid" style="background-color: #ddd;">
                            <div class="demo-masked-input">
                                <div class="row clearfix">
                                    ...
                                    <input type="submit" name="otulogisticsupdate" value="Update" class="btn btn-success" style ="float:right; margin-top: -30px;">                   
                                </div>
                            </div>
                        </div>
                    </div>
