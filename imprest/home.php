...
<script src="js/bootstrap.js"></script>
	...
	<ul class="cb-slideshow">
			...
			<p style="background-color:green; margin-left:40px; padding: 10px; float:left"><img src="images/user.png" height="50px" /></p></br> <p style="font-size: 16px; color: white">Imprest </br>Manager</p></div>
			
			<div id="result" style="padding: 20px 5px 20px 10px; float:right; background-color: white; width:360px; height:379px; overflow-y:scroll; ">
			<?php
			...
			<input type="text" class="hidden" value="Imprest Manager" name="name" id="name"></input>
