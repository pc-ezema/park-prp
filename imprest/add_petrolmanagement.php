<?php include("header.php") ?>
    ...
    <section class="content">
        <div class="container-fluid">
               <!-- Input Group -->
        <form action="query/add_petrolmanagement_query.php" method="POST" enctype="multipart/form-data" name="form1" id="form1">
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class = "panel panel-success">
                            <div class = "panel-heading">
                                <h4>Add Petrol Management</h4>
                            </div>
                        </div>
                        <div class="body">
                                ...
                                <div class="row clearfix">
                                    ...
                                    <div class="col-sm-5">
                                        <div>
                                            ...
                                            <div>
												<textarea type="text" rows="5" class="form-control" name="unit" required></textarea>
                                            </div>
                                        </div>
                                    </div>
									...
									<div class="col-sm-3">
										<div>
                                            ...
                                            <div class="form-line">
                                                <input type="text" class="form-control" name="requested" required>
                                            </div>
                                        </div>
                                    </div>
									...
									<div class="col-sm-6">
                                        <div>
                                            ...
                                            <div class="form-line">
												<textarea type="text" rows="5" class="form-control" name="remarks" required></textarea>
                                            </div>
                                        </div>
                                    </div>
