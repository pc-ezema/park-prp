                    ...
                    <div class="card">
                        <div class = "panel panel-success">
                            <div class = "panel-heading">
                                ...
                                <a href="print_imprest/print_adminimprest.php">
                        ...
                        <div id="print">
                            ...
                            <div class="body">
                             ...
                             <table id = "example" class = "stripe" cellspacing = "0" >
								...
								<?php
                                    include('connect.php');
                                    $display = $con->prepare("SELECT * FROM adminimprest ORDER BY id DESC");
                                    $display->execute();
								  ...
								  <td>     
									...
									<a class="btn btn-success btn-sm" href="query/delete_inventory_query.php?adminid=<?php echo $row['id']?>">
								...
								<?php
										include('connect.php');
										$display = $con->prepare("SELECT sum(Amount) FROM adminimprest");
										$display->execute();
