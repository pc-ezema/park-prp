                        ...
                        <div id="print">
                            ...
                            <div class="body">
                             ...
                             <table id = "example" class = "stripe" cellspacing = "0" >
								...
								<?php
                                    include('connect.php');
                                    $display = $con->prepare("SELECT * FROM fisheryimprest ORDER BY id DESC");
                                    $display->execute();
								  ...
								  <td>     
                                     <a href="edit_fishery.php?id=<?php echo $row['id']?>" class="btn btn-primary">
                                      <span class = "glyphicon glyphicon-pencil" aria-hidden = "true">Edit</span>
                                    </a>
									<a class="btn btn-success btn-sm" href="query/delete_inventory_query.php?fisheryid=<?php echo $row['id']?>">
								...
								<?php
										include('connect.php');
										$display = $con->prepare("SELECT sum(Amount) FROM fisheryimprest");
										$display->execute();
