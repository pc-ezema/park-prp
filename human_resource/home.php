...
<script src="js/bootstrap.js"></script>
        ...
        <ul class="cb-slideshow">
			...
			<p style="background-color:green; margin-left:40px; padding: 10px; float:left"><img src="images/user.png" height="50px" /></p></br> <p style="font-size: 16px; color: white">Human </br>Resource</p></div>
			...
			<input type="text" class="hidden" value="Human Resource" name="name" id="name"></input>
