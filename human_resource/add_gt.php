<?php include("header.php") ?>
    ...
    <section class="content">
        <div class="container-fluid">
               <!-- Input Group -->
        <form action="query/add_gt_query.php" method="POST" enctype="multipart/form-data" name="form1" id="form1">
            <div class="row clearfix">
                    <div class="card">
                        <div class = "panel panel-success">
                            <div class = "panel-heading">
                                <h4>Add Graduate Trainee Profile</h4>
                            </div>
                            ...
                            <div class="demo-masked-input">
                                <div class="row clearfix">
									...
									<div class="col-sm-12">
									    <div>
                                            <span>
                                                Training Expectation(s):<input type="text" class="form-control" name="trainingexpectation" required></br>
                                            </span>
                                        </div>
                                    </div>
									</fieldset>
									...
									<div class="col-sm-12">
									    <div>
                                            <span>
                                                Company Name:<input type="text" class="form-control" name="companyname" required></br>
                                            </span>
                                        </div>
                                    </div>
									<div class="col-sm-12">
									    <div>
                                            <span>
                                                Company Address:<input type="text" class="form-control" name="companyaddress" required></br>
                                            </span>
                                        </div>
                                    </div>
									<div class="col-sm-12">
									    <div>
                                            <span>
                                                Designation:<input type="text" class="form-control" name="designation" required></br>
                                            </span>
                                        </div>
                                    </div>
									<div class="col-sm-12">
									    <div>
                                            <span>
                                                Name of Supervisor:<input type="text" class="form-control" name="nameofsupervisor" required></br>
                                            </span>
                                        </div>
                                    </div>
									<div class="col-sm-12">
									    <div>
                                            <span>
                                                Phone Number of Supervisor:<input type="number" class="form-control" name="phonenumbersupervisor" required></br>
                                            </span>
                                        </div>
                                    </div>
									</fieldset>
