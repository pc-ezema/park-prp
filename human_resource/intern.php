                        ...
                        <div id="print">
                            ...
                            <div class="body">
                                ...
                                <tbody class="alert-success">
								  ...
								  <td> 
									<a class="btn btn-success btn-xs" href="view_intern.php?id=<?php echo $row['Siwesid']?>">
                                      <span class = "glyphicon glyphicon-eye-open" aria-hidden = "true">View</span>
                                    </a> 
                                    <a class="btn btn-success btn-xs" href="edit_intern.php?id=<?php echo $row['Siwesid']?>">
                                      <span class = "glyphicon glyphicon-edit" aria-hidden = "true">Edit</span>
                                    </a> 
									<a class="btn btn-success btn-xs" href="query/delete_intern_query.php?id=<?php echo $row['Siwesid']?>">
