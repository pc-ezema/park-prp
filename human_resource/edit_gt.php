...
?>
    ...
    <section class="content">
        <div class="container-fluid">
               <!-- Input Group -->
        <form action="query/edit_gt_query.php" method="POST" enctype="multipart/form-data" name="form1" id="form1">
            <div class="row clearfix">
                    <div class="card">
                        <div class = "panel panel-success">
                            <div class = "panel-heading">
                                <h4>Edit Graduate Trainee Bio-Data</h4>
                            </div>
                            ...
                            <div class="demo-masked-input">
                                <div class="row clearfix">
									...
									<div class="col-sm-12">
									    <div>
                                            <span>
                                                Home Place (Town/Village of Origin):<input type="text" class="form-control" value="<?php echo $row['HomePlace']; ?>" name="homeplace" required></br>
                                            </span>
                                        </div>
                                    </div>
									<div class="col-sm-12">
									...
									<div class="col-sm-12">
									    <div>
                                            <span>
                                                Email Address:<input type="email" class="form-control" name="email" value="<?php echo $row['Email']; ?>" required></br>
                                            </span>
                                        </div>
                                    </div>
									<div class="col-sm-12">
									...
									<div class="col-sm-12">
									    <div>
                                            <span>
                                                Any Known Health Limitations:<input type="text" class="form-control" value="<?php echo $row['HealthLimitations']; ?>" name="healthlimitations" required></br>
                                            </span>
                                        </div>
                                    </div>
									<div class="col-sm-12">
                            ...
                            <div class="demo-masked-input">
                                <div class="row clearfix">
									...
									<div class="col-sm-12">
									    <div>
                                            <span>
                                                Training Expectation(s):<input type="text" class="form-control" name="trainingexpectation" value="<?php echo $row['TrainingExpectation']; ?>" required></br>
                                            </span>
                                        </div>
                                    </div>
									</fieldset>
									...
									<div class="col-sm-12">
									    <div>
                                            <span>
                                                Company Name:<input type="text" class="form-control" name="companyname" value="<?php echo $row['CompanyName']; ?>" required></br>
                                            </span>
                                        </div>
                                    </div>
									<div class="col-sm-12">
									    <div>
                                            <span>
                                                Company Address:<input type="text" class="form-control" name="companyaddress" value="<?php echo $row['CompanyAddress']; ?>" required></br>
                                            </span>
                                        </div>
                                    </div>
									<div class="col-sm-12">
									    <div>
                                            <span>
                                                Designation:<input type="text" class="form-control" name="designation" value="<?php echo $row['Designation']; ?>" required></br>
                                            </span>
                                        </div>
                                    </div>
									<div class="col-sm-12">
									    <div>
                                            <span>
                                                Name of Supervisor:<input type="text" class="form-control" name="nameofsupervisor" value="<?php echo $row['NameofSupervisor']; ?>" required></br>
                                            </span>
                                        </div>
                                    </div>
									<div class="col-sm-12">
									    <div>
                                            <span>
                                                Phone Number of Supervisor:<input type="number" class="form-control" name="phonenumbersupervisor" value="<?php echo $row['PhoneNumberSupervisor']; ?>" required></br>
                                            </span>
                                        </div>
                                    </div>
									</fieldset>
