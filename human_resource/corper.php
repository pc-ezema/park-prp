                        ...
                        <div id="print">
                            ...
                            <div class="body">
                                ...
                                <tbody class="alert-success">
								  ...
								  <td> 
									<a class="btn btn-success btn-xs" href="view_corper.php?id=<?php echo $row['corperid']?>">
                                      <span class = "glyphicon glyphicon-eye-open" aria-hidden = "true">View</span>
                                    </a> 
                                    <a class="btn btn-success btn-xs" href="edit_corper.php?id=<?php echo $row['corperid']?>">
                                      <span class = "glyphicon glyphicon-edit" aria-hidden = "true">Edit</span>
                                    </a> 
									<a class="btn btn-success btn-xs" href="query/delete_corper_query.php?id=<?php echo $row['corperid']?>">
