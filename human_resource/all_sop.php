                        ...
                        <div id="print">
                            ...
                            <div class="body">
                                ...
                                <tbody class="alert-success">
								  ...
								  <?php
                                    include('connect.php');
                                    $display = $con->prepare("SELECT * FROM file WHERE department='Human Resource(SOP)' ORDER BY file_id DESC");
                                    $display->execute();
								  ...
								  <td>     
                                     <a href="sopdownload.php?file=<?php echo $name[1]?>" class="btn btn-primary">
                                      <span class = "glyphicon glyphicon-pencil" aria-hidden = "true">Download</span>
                                    </a>
									<a class="btn btn-success btn-sm" href="deletesop.php?file_id=<?php echo $row['file_id']?>">
