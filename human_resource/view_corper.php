...
?>
    ...
    <section class="content">
        <div class="container-fluid">
               <!-- Input Group -->
        <form action="corper.php" method="POST" enctype="multipart/form-data" name="form1" id="form1">
            <div class="row clearfix">
                    <div class="card">
                        <div class = "panel panel-success">
                            <div class = "panel-heading">
                                <h4>Corp Member Profile</h4>
                            </div>
                            ...
                            <div class="demo-masked-input">
                                <div class="row clearfix">
									...
									<div class="col-sm-12">
									    <div>
                                            <span>
                                                Country:<input type="text" class="form-control" name="country" value="<?php echo $row['Country']; ?>" readonly></br>
                                            </span>
                                        </div>
                                    </div>
									<div class="col-sm-12">
									...
									<div class="col-sm-12">
									    <div>
                                            <span>
                                                Home Place (Town/Village of Origin):<input type="text" class="form-control" name="homeplace" value="<?php echo $row['HomePlace']; ?>"  readonly></br>
                                            </span>
                                        </div>
                                    </div>
									<div class="col-sm-12">
									...
									<div class="col-sm-12">
									    <div>
                                            <span>
                                                Email:<input type="email" class="form-control" name="email" value="<?php echo $row['Email']; ?>" readonly></br>
                                            </span>
                                        </div>
                                    </div>
									<div class="col-sm-12">
                            ...
                            <div class="demo-masked-input">
                                <div class="row clearfix">
									...
									<div class="col-sm-12">
									    <div>
                                            <span>
                                                Any Known Health Limitations:<input type="text" class="form-control" name="healthlimitations" value="<?php echo $row['HealthLimitations']; ?>" readonly></br>
                                            </span>
                                        </div>
                                    </div>
									<div class="col-sm-12">
									...
									<div class="col-sm-12">
									    <div>
                                            <span>
                                                Highest Level of Education:<input type="text" class="form-control" name="leveleducation" value="<?php echo $row['LevelEducation']; ?>" readonly></br>
                                            </span>
                                        </div>
                                    </div>
									<div class="col-sm-12">
									...
									<div class="col-sm-12">
									    <div>
                                            <span>
                                                Cordinator Name/Number:<input type="text" class="form-control" name="coordinatornn" value="<?php echo $row['CoordinatorName']; ?>" readonly></br>
                                            </span>
                                        </div>
                                    </div>
									</fieldset>
