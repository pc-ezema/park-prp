                    ...
                    <div class="card">
                        <div class = "panel panel-success">
                            <div class = "panel-heading">
                                <h4>ALL HR REQUISITION</h4>
                                <a href="print_all_hrrequisition.php">
                        ...
                        <div id="print">
                            ...
                            <div class="body">
                                ...
                                <tbody class="alert-success">
                                  <?php
                                    include('connect.php');
                                    $display = $con->prepare("SELECT * FROM tblrequisition WHERE PreparedBy='Human Resource' ORDER BY i_id DESC");
                                    $display->execute();
								  ...
								  <td>     
                                    <a class="btn btn-success btn-sm" href="approve_hrrequisition.php?i_id=<?php echo $row['i_id']?>">
