                                ...
                                <div class="row clearfix">
									...
									<div class="col-sm-9">
                                        <div>
                                            ...
                                            <div class="form-line">
                                                <input type="file" class="form-control" name="attachment" /></textarea>
                                            </div>
                                        </div>
                                    </div>
									...
									<div class="col-sm-3">
                                        <div>
                                            ...
                                            <div class="form-line">
                                                <textarea type="text" class="form-control" rows="10px" name="message" required /></textarea></br></br>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <input type="submit" name="send" value="Send" class="btn btn-success" style ="float:right; margin-top: -30px;">                   
                                </div>
