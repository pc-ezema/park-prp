...
<center>
  <div class="backk" style="float: left; margin-left: 120px;">
    <button><a href="all_suppliers.php">Back</a></button>
  </div>
  ...
  <div id="print" style="border: 1px solid; width: 80%; height: auto;">
    <div class="report-title" style = "margin:10px;"><br/>
      ...
      <br />
      <center><strong>SUMMARY OF ALL SUPPLIERS DONE</strong></center>
    </div>
      <br />
      <br />
      <br />
      ...
      <table id="example" class="stripe order-table" cellspacing="0">
        <thead>
                                ...
                                <tbody class="alert-success">
                                  ...
                                  <?php
                                    include('connect.php');
                                    $display = $con->prepare("SELECT * FROM tblsupplier ORDER BY SUPID DESC");
                                    $display->execute();
                                  ...
                                  <td><?php echo $row['SUPTIN']; ?></td>
								  <td><?php echo $row['SUPADD']; ?></td>
								  <td><?php echo $row['SUPCONTACT']; ?></td>
								  <td><?php echo $row['SUPREMARKS']; ?></td>
                                 </tr>                           
                                     <?php 
                                     } ?>
                                </tbody>
      ...
      <div class="noted">
        ...
        <br>
        <br>
        <label style="text-transform: uppercase;"><strong>PARK SPECIAL PROJECT MANAGER</strong></label>
        <br><br><br>
      </div>
    </div>
  </div>
