...
<center>
  <div class="backk" style="float: left; margin-left: 120px;">
    <button><a href="all_sprequisition.php">Back</a></button>
  </div>
  ...
  <div id="print" style="border: 1px solid; width: 80%; height: auto;">
    <div class="report-title" style = "margin:10px;"><br/>
      ...
      <br /></br>
      <center><strong>SUMMARY OF ALL SPECIAL PROJECT APPLIED REQUISITION</strong></center>
    </div>
      <br />
      <br />
      <br />
      ...
      <table id="example" class="stripe order-table" cellspacing="0">
        <thead>
                                ...
                                <tbody class="alert-success">
                                  ...
                                  <?php
                                    include('connect.php');
                                    $display = $con->prepare("SELECT * FROM tblrequisition WHERE PreparedBy='Special Project Manager' ORDER BY i_id DESC");
                                    $display->execute();
      ...
      <div class="noted">
        ...
        <br>
        <br>
        <label style="text-transform: uppercase;"><strong>SPECIAL PROJECT MANAGER</strong></label>
        <br><br><br>
      </div>
    </div>
  </div>
