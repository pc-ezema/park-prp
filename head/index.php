...
<body>
	<div class = "navbar navbar-default" style="background-color:green;">
		<img src = "images/bg/agrologo.jpg" style = "float:left;" height = "55px" /><marquee width="88%" direction="left" ><span class = "navbar-brand" style = "float:left;" >PARK ADMINISTRATIVE SERVICES</span></marquee>
	</div>
	...
	<div id = "top" class = "login">
		...
		<div class = "panel panel-success">
			<div class = "panel-heading">
				...
				<center><h1 class = "panel-title">Head, Park Management Services</h1></center>
			</div>
