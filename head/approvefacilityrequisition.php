...
if(isset($_POST['update'])) {
	...
	//Server settings
        ...
        //Recipients
        $mail->addAddress('akinyemisamuel@agropark.ng');  
	...
	$approve_facilityrequisition = $con->prepare("UPDATE tblrequisition SET  `PreparedBy` = ?, `Date` = ?, `Department` = ?,	`Phone_No` = ?, 
	...
	$approve_facilityrequisition->execute(array($PreparedBy, $Date, $Department, $Phone_No, $Purpose, $Purchase_Mode, $Name, $Address, $PhoneNO, 
