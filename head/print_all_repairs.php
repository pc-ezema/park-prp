...
<center>
  <div class="backk" style="float: left; margin-left: 120px;">
    <button><a href="all_repairs.php">Back</a></button>
  </div>
  ...
  <div id="print" style="border: 1px solid; width: 80%; height: auto;">
    <div class="report-title" style = "margin:10px;"><br/>
      ...
      <br />
      <center><strong>SUMMARY OF ALL REPAIRS DONE</strong></center>
    </div>
      <br />
      <br />
      <br />
      ...
      <table id="example" class="stripe order-table" cellspacing="0">
        <thead>
                                    <tr>
                                        ...
                                        <td>Date Repaired</td>
                                        <td>Month of Repairs</td>
                                        <td>Repair Performed By</td>
                                        <td>Cost of Repair</td>
                                        <td>Description of Repair or Remedy</td>
                                        <td>Remarks</td>
                                    </tr>
                                </thead>
                                <tbody class="alert-success">
                                  ...
                                  <td><?php echo $row['MonthofRepairs']; ?></td>
