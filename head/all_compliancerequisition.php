                    ...
                    <div class="card">
                        <div class = "panel panel-success">
                            <div class = "panel-heading">
                                <h4>ALL COMPLIANCE REQUISITION</h4>
                                <a href="print_all_compliancerequisition.php">
                        ...
                        <div id="print">
                            ...
                            <div class="body">
                                ...
                                <tbody class="alert-success">
								  ...
								  <td>     
                                    <a class="btn btn-success btn-sm" href="approve_compliancerequisition.php?i_id=<?php echo $row['i_id']?>">
