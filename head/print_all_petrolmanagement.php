...
<center>
  <div class="backk" style="float: left; margin-left: 120px;">
    <button><a href="all_petrolmanagement.php">Back</a></button>
  </div>
  ...
  <div id="print" style="border: 1px solid; width: 80%; height: auto;">
    <div class="report-title" style = "margin:10px;"><br/>
      ...
      <br />
      <center><strong>SUMMARY OF ALL PETROL MANAGEMENT</strong></center>
    </div>
      <br />
      <br />
      <br />
      ...
      <table id="example" class="stripe order-table" cellspacing="0">
        <thead>
                                    <tr>
                                        <th>Unit (form Monday - Saturday)</th>
                                        <th>Requested Liters</th>
										<th>Actual Giving Liters</th>
                                        <th>Remarks</th>
                                    </tr>
                                </thead>
      ...
      <div class="noted">
        ...
        <br>
        <br>
        <label style="text-transform: uppercase;"><strong>PARK IMPREST/PROCUREMENT MANAGER</strong></label>
        <br><br><br>
      </div>
    </div>
  </div>
