...
<?php include('notification/connection.php'); ?>
...
<script src="js/bootstrap.js"></script>
	...
	<ul class="cb-slideshow">
		...
		<tr>
			...
			<p style="background-color:green; margin-left:40px; padding: 10px; float:left"><img src="images/user.png" height="50px" /></p></br> <p style="font-size: 16px; color: white">Head, </br>Park Administrative Services</p></div>
			...
			<input type="text" class="hidden" value="Head: " name="name" id="name"></input>
