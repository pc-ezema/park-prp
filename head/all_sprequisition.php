                    ...
                    <div class="card">
                        <div class = "panel panel-success">
                            <div class = "panel-heading">
                                <h4>ALL SPECIAL PROJECT REQUISITION</h4>
                                <a href="print_all_sprequisition.php">
                        ...
                        <div id="print">
                            ...
                            <div class="body">
                                ...
                                <tbody class="alert-success">
								  ...
								  <td>     
                                    <a class="btn btn-success btn-sm" href="approve_sprequisition.php?i_id=<?php echo $row['i_id']?>">
