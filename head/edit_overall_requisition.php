...
$result=$con->prepare("SELECT * FROM file WHERE file_id='{$_GET['file_id']}'");
$result->execute();
...
?>
    ...
    <section class="content">
        <div class="container-fluid">
               <!-- Input Group -->
        <form action="approve_overall_requisition.php" method="POST" enctype="multipart/form-data" name="form1" id="form1">
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class = "panel panel-success">
                            <div class = "panel-heading">
                                <h4>EVALUATE OVERALL REQUISITION</h4>
                            </div>
                        </div>
                        <div class="body">
