...
if(isset($_POST['update'])) {
	...
	$approve_hrrequisition = $con->prepare("UPDATE tblrequisition SET  `PreparedBy` = ?, `Date` = ?, `Department` = ?,	`Phone_No` = ?, 
	...
	$approve_hrrequisition->execute(array($PreparedBy, $Date, $Department, $Phone_No, $Purpose, $Purchase_Mode, $Name, $Address, $PhoneNO, 
