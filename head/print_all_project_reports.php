...
<center>
  <div class="backk" style="float: left; margin-left: 120px;">
    <button><a href="weekly_reports.php">Back</a></button>
  </div>
  ...
  <div id="print" style="border: 1px solid; width: 80%; height: auto;">
    <div class="report-title" style = "margin:10px;"><br/>
      ...
      <br />
      <center><strong>SUMMARY OF ALL SPECIAL PROJECT REPORT</strong></center>
    </div>
      <br />
      <br />
      <br />
      ...
      <table id="example" class="stripe order-table" cellspacing="0">
        <thead>
                                ...
                                <tbody class="alert-success">
                                  ...
                                  <?php
                                    include('connect.php');
                                    $display = $con->prepare("SELECT * FROM file WHERE department='Special Project' ORDER BY file_id DESC");
                                    $display->execute();
