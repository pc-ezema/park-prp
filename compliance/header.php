...
<!--    <meta http-equiv="refresh" content="1"> -->
    ...
    <title>COMPLAINCE | PARK ADMINISTRATIVE SERVICES </title>
    ...
    <nav class="navbar">
        <div class="container-fluid" style="background-color:green;">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="home.php" style="color: #fff;">Compliance Manager</a>
                ...
                <ul class="list">
                    ...
                    <li>
                        <a href="javascript:void(0);" class="menu-toggle">
                            <i class="glyphicon glyphicon-th-large"></i>&nbsp;&nbsp;Compliance
                        </a>
                        <ul class="ml-menu">
                            <li>
                                <a href="all_non-compliance.php">Non Compliance</a>
                            </li>
                            <li>
                                <a href="all_checklist.php">Inspection CheckList </a>
                            </li>
                            <li>
                    ...
                    <li>
                        <a href="javascript:void(0);" class="menu-toggle">
                            ...
                            <i class="glyphicon glyphicon-phone"></i>&nbsp;&nbsp;Report
                        </a>
                        <ul class="ml-menu">
							<li>
							...
							<li>
                                <a href="all_complain.php">Complains</a>
                            </li>
						</ul>
                    </li>
					<li>
                        <a href="javascript:void(0);" class="menu-toggle">
                            ...
                            <i class="glyphicon glyphicon-book"></i>&nbsp;&nbsp;Requisition
                        </a>
                        <ul class="ml-menu">
							<li>
                                <a href="all_requisition.php">Requisition</a>
                            </li>
						</ul>
                    </li>
					<li>
