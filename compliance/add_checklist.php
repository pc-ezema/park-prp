<?php include("header.php") ?>
    ...
    <section class="content">
        <div class="container-fluid">
               <!-- Input Group -->
        <form action="query/add_checklist_query.php" method="POST" enctype="multipart/form-data" name="form1" id="form1">
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class = "panel panel-success">
                            <div class = "panel-heading">
                                <h4>Add Inspection Checklist</h4>
                            </div>
                        </div>
                            ...
                            <div class="demo-masked-input">
                                <div class="row clearfix">
									...
									<div class="col-sm-12">
									    <div>
                                            <span>
                                                Name of Office:<input type="text" class="form-control" name="name_office" required>
                                            </span>
                                        </div>
                                    </div>
									<div class="col-sm-12">
									    <div>
                                            <span>
                                                Area Inspected:<textarea type="text" rows="2" class="form-control" name="area_inspected" style="resize:none;"  required></textarea>
                                            </span>
                                        </div>
                                    </div>
									<div class="col-sm-12">
									    <div>
                                            <span>
                                                Inspected By:<input type="text" class="form-control" name="inspected_by" required>
                                            </span>
                                        </div>
                                    </div>
									<div class="col-sm-12">
									...
									<div class="col-sm-12">
									    <div>
                                            <span>
                                                Item:<textarea type="text" rows="2" class="form-control" name="item" style="resize:none;"  required></textarea>
                                            </span>
                                        </div>
                                    </div>
									<div class="col-sm-12">
									    <div>
                                            <span>
                                                Yes/No:<input type="text" class="form-control" name="yes_no" required>
                                            </span>
                                        </div>
                                    </div>
									<div class="col-sm-12">
									    <div>
                                            <span>
                                                Corrective Action:<textarea type="text" rows="4" class="form-control" name="corrective_action" style="resize:none;"  required></textarea>
                                            </span>
                                        </div>
                                    </div>
