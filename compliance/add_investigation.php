<?php include("header.php") ?>
    ...
    <section class="content">
        <div class="container-fluid">
               <!-- Input Group -->
        <form action="query/upload_investigation_query.php" method="POST" enctype="multipart/form-data" name="form1" id="form1">
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class = "panel panel-success">
                            <div class = "panel-heading">
                                <h4>Add Investigation Report</h4>
                            </div>
                        </div>
                        <div class="body">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div>
                                            ...
                                            <div class="form-line">
                                                ...
                                                <input type="hidden" class="form-control" name="department" value="Investigation" required>
                                            </div>
                                        </div>
									</div>	
									<div class="col-sm-4">
