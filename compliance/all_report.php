                        ...
                        <div id="print">
                            ...
                            <div class="body">
                                ...
                                <tbody class="alert-success">
								  ...
								  <?php
                                    include('connect.php');
                                    $display = $con->prepare("SELECT * FROM tblcompliancefile WHERE department='Weekly Report' ORDER BY file_id DESC");
                                    $display->execute();
								  ...
								  <td>     
									...
									<a class="btn btn-success btn-sm" href="deletereport.php?file_id=<?php echo $row['file_id']?>">
