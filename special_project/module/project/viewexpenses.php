                ...
                <table class="table-striped" align="left"  width="100%" >  
                  ...
                  <tbody>           
                    <tr>
                      ...
                      <td><strong>Project Name</strong></td><td align="left"> <?php echo (isset($sProject)) ? $sProject->PROJECTNAME : 'Project Name' ;?>
                      <tr>
                      ...
                      <tr>
                      <td><strong>Project Cost</strong></td><td> <?php echo (isset($sProject)) ? number_format($sProject->PROJECTCOST,2) : 'Project Cost' ;?>
                      <?php
                      ...
                      <tr>
                      <td><strong>Total Expenses</strong></td><td> <?php echo (isset($sProject)) ? number_format($sProject->PROJECTEXPENSES,2)  : 'Total Expenses' ;?>
                       <tr>
                      <td><strong>Available Funds</strong></td><td> <?php echo (isset($sProject)) ? number_format($remFund,2)   : 'Available Funds' ;?><br/>
                      <tr>
    ...
    <div class="col-lg-12">
     <div class="card mb-3">
         <div class="card-header">
              ...
              <button class="btn btn-primary btn-sm"  data-toggle="modal" data-target="#addexpenses" id="addNewExpenses">  <i class="fa fa-plus-circle fw-fa"></i> New</button>
