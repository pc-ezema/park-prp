...
<div class="card mb-3">
        ...
        <div class="card-header">
          <i class="fa fa-table"></i> List of Work Plan(s)   <a href="index.php?view=add" class="btn btn-primary  ">  <i class="fa fa-plus-circle fw-fa"></i> New</a></div>
				...
				<table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
				  ...
				  <tbody class="alert-success">
					<?php
						...
						$row = $conn->query("SELECT * FROM `file` WHERE department='Special Project Work Plan' ORDER BY file_id DESC") or die(mysqli_error());
